...
// getDockerFileStoreCredentialResponseXML mirrors Aliyun XML root GetDockerFileStoreCredentialResponse.
type getDockerFileStoreCredentialResponseXML struct {
	XMLName        xml.Name                             `xml:"GetDockerFileStoreCredentialResponse"`
	Code           *string                              `xml:"Code"`
	Data           *getDockerFileStoreCredentialDataXML `xml:"Data"`
	HttpStatusCode *int32                               `xml:"HttpStatusCode"`
	Message        *string                              `xml:"Message"`
	RequestId      *string                              `xml:"RequestId"`
	Success        *bool                                `xml:"Success"`
...
type getDockerFileStoreCredentialDataXML struct {
	OssUrl *string `xml:"OssUrl"`
...
// parseGetDockerFileStoreCredentialResponse builds GetDockerFileStoreCredentialResponse from CallApi map (bodyType "string").
// Backend may return XML (e.g. Bearer/OAuth) or JSON (e.g. AK); same pattern as GetMarketSkillCredential.
func parseGetDockerFileStoreCredentialResponse(res map[string]interface{}) (*GetDockerFileStoreCredentialResponse, error) {
	out := &GetDockerFileStoreCredentialResponse{}
	bodyStr := ""
	switch v := res["body"].(type) {
	case string:
		bodyStr = v
	...
	parsed := &GetDockerFileStoreCredentialResponseBody{}
	if bodyStr != "" {
		trimmed := strings.TrimSpace(bodyStr)
		if len(trimmed) > 0 && trimmed[0] == '<' {
			var xmlResp getDockerFileStoreCredentialResponseXML
			if err := xml.Unmarshal([]byte(bodyStr), &xmlResp); err != nil {
				return nil, &ErrWithRequestID{Err: err, RequestID: extractRequestIDFromResponse(res)}
			}
			parsed.Code = xmlResp.Code
			...
			if xmlResp.Data != nil {
				d := xmlResp.Data
				parsed.Data = &GetDockerFileStoreCredentialResponseBodyData{
					OssUrl: d.OssUrl,
					TaskId: d.TaskId,
				}
			}
...
func (client *Client) GetDockerFileStoreCredentialWithOptions(request *GetDockerFileStoreCredentialRequest, runtime *dara.RuntimeOptions) (_result *GetDockerFileStoreCredentialResponse, _err error) {
	...
	params := &openapiutil.Params{
		...
		// BodyType "string": backend may return XML (Bearer) or JSON (AK); parse manually like GetMarketSkillCredential.
	...
	_result, _err = parseGetDockerFileStoreCredentialResponse(_body)
	return _result, _err
}
...
// Uses BodyType "string" so we parse XML/JSON manually (backend may return XML).
func (client *Client) CreateApiKeyWithOptions(request *CreateApiKeyRequest, runtime *dara.RuntimeOptions) (_result *CreateApiKeyResponse, _err error) {
	...
	_result, _err = parseCreateApiKeyResponse(_body)
	return _result, _err
}
...
// parseCreateApiKeyResponse builds CreateApiKeyResponse from CallApi map (bodyType "string").
func parseCreateApiKeyResponse(res map[string]interface{}) (*CreateApiKeyResponse, error) {
	...
	parsed := &CreateApiKeyResponseBody{}
	if bodyStr != "" {
		if err := json.Unmarshal([]byte(bodyStr), parsed); err != nil {
			return nil, &ErrWithRequestID{Err: err, RequestID: extractRequestIDFromResponse(res)}
		}
...
// ModifyMcpApiKeyConfig 修改 MCP API Key 配置（会话并发设置）
func (client *Client) ModifyMcpApiKeyConfigWithOptions(request *ModifyMcpApiKeyConfigRequest, runtime *dara.RuntimeOptions) (_result *ModifyMcpApiKeyConfigResponse, _err error) {
	...
	_result, _err = parseModifyMcpApiKeyConfigResponse(_body)
	return _result, _err
}
...
func (client *Client) ModifyMcpApiKeyConfig(request *ModifyMcpApiKeyConfigRequest) (_result *ModifyMcpApiKeyConfigResponse, _err error) {
	runtime := &dara.RuntimeOptions{}
	return client.ModifyMcpApiKeyConfigWithOptions(request, runtime)
}

// ModifyMcpApiKeyConfigWithContext 修改 MCP API Key 配置（会话并发设置），支持 context
...
// DescribeNetworkPackages 查询网络包列表
func (client *Client) DescribeNetworkPackagesWithOptions(request *DescribeNetworkPackagesRequest, runtime *dara.RuntimeOptions) (_result *DescribeNetworkPackagesResponse, _err error) {
	...
	_result, _err = parseDescribeNetworkPackagesResponse(_body)
	return _result, _err
}
...
// parseDescribeNetworkPackagesResponse builds DescribeNetworkPackagesResponse from CallApi map (bodyType "string").
func parseDescribeNetworkPackagesResponse(res map[string]interface{}) (*DescribeNetworkPackagesResponse, error) {
	out := &DescribeNetworkPackagesResponse{}
	bodyStr := ""
	switch v := res["body"].(type) {
	case string:
		bodyStr = v
	...
	parsed := &DescribeNetworkPackagesResponseBody{}
	if bodyStr != "" {
		if err := json.Unmarshal([]byte(bodyStr), parsed); err != nil {
			return nil, &ErrWithRequestID{Err: err, RequestID: extractRequestIDFromResponse(res)}
		}
...
// parseModifyMcpApiKeyConfigResponse builds ModifyMcpApiKeyConfigResponse from CallApi map (bodyType "string").
func parseModifyMcpApiKeyConfigResponse(res map[string]interface{}) (*ModifyMcpApiKeyConfigResponse, error) {
	out := &ModifyMcpApiKeyConfigResponse{}
	bodyStr := ""
	switch v := res["body"].(type) {
	case string:
		bodyStr = v
	...
	parsed := &ModifyMcpApiKeyConfigResponseBody{}
	if bodyStr != "" {
		if err := json.Unmarshal([]byte(bodyStr), parsed); err != nil {
			return nil, &ErrWithRequestID{Err: err, RequestID: extractRequestIDFromResponse(res)}
		}
